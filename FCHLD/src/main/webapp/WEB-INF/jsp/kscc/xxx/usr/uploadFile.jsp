...
<script src="<c:url value='/js/usr/uploadFile.js'/>" ></script>
...
<input type="hidden" name="errorMessage" value="${errorMessage}"/>
    ...
    <form method="post" action="<c:url value='/usr/uploadFile.do'/>" enctype="multipart/form-data">
      <p>Type:
        ...
        <div class="Lwrapper">
            <div class="LblockPageSubtitle">
                ...
                <div id="LblockSubbutton01" class="LblockSubbutton">
                    <span class="LbtnIcon"><a href="javascript:;" id="btnExcel" name="btnExcel"><img src="<c:url value='/images/icon_down.gif'/>" alt="파일다운로드"/>파일다운로드</a></span>
                </div>
            </div>
