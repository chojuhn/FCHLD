...
<script src="<c:url value='/js/usr/readUsrExcel.js'/>" ></script>
    ...
    <div class="Lwrapper">
      <div class="LblockPageSubtitle">
        ...
        <div id="LblockSubbutton01" class="LblockSubbutton">
          <span class="LbtnIcon"><a href="javascript:;" id="btnExl" name="btnExl"><img src="<c:url value='/images/icon_down.gif'/>" alt="EXL다운로드"/>EXL다운로드</a></span>
          <span class="LbtnIcon"><a href="javascript:;" id="btnCsv" name="btnCsv"><img src="<c:url value='/images/icon_down.gif'/>" alt="CSV다운로드"/>CSV다운로드</a></span>
        </div>
      </div>
