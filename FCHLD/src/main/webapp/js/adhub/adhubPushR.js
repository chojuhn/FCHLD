	...
	function loading(pntAcmtDvs,pntAcmtRto,pntAcmtAmt,stlmMthd,stlmMthd2,ptuCyc){
...
//		alert("blbrExpsYn :"+blbrExpsYn + " pupExpsYn :"+pupExpsYn + "  pushExpsYn :"+pushExpsYn);
...
//			$("#msgLandCont").val($("#msgLandCont").val());
		...
		$("#msgTypeCd").val(msgTypeCd);
		
		if ( confirm("저장을 하시겠습니까?") ) {
			$("#form").attr("action","/mktp/adhub/insertAdPush.do");		
			$("#form").submit();
		}
	}
