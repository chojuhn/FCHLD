 ...
 * 확인 버튼 click
 */
function btnChoice(gubun) {
	var mhrkCd 		= $("input[name=mhrkCd]").val();
	var mhrkCdNm 	= $("input[name=mhrkCdNm]").val();
	var hgrnCd 		= $("input[name=cd]").val();
	var hgrnCdNm 	= $("input[name=cdNm]").val();	
//alert("mhrkCd : "+mhrkCd +"//mhrkCdNm : "+mhrkCdNm);
//alert("hgrnCd : "+hgrnCd +"//hgrnCdNm : "+hgrnCdNm);
	parent.window.opener.getReturnValue(mhrkCdNm,gubun,hgrnCdNm,mhrkCd,hgrnCd);
	window.close();	
...
function setDisplayMode(mode) {
	...
	/*			ComUtil.setDisableBtn("btnMhrkInsert"	, false);
		...
		ComUtil.setDisableObj("btnChoice"	, true);
		ComUtil.setDisableObj("btnClose"	, true);	
/*		case "INSERT":
		case "UPDATE":
