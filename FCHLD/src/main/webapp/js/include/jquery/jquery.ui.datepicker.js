...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonText: '달력', //'calendar', // Text for trigger button
		buttonImage: '/manage/images/common/oCalendar.gif', // URL for trigger button image
		buttonImageOnly: false, // 버튼모양일경우 false, 이미지만 true
