    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://localhost:8082/jsp/manage/include_files/common_server/common_file_upload_se2_action.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://localhost:8082/jsp/manage/include_files/common_server/common_file_upload_se2_action.do',
