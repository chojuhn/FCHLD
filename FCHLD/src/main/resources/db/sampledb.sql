...
CREATE MEMORY TABLE MYTABLE(ID VARCHAR(16) NOT NULL PRIMARY KEY,USER_NAME VARCHAR(50),DEPT_NAME VARCHAR(100),POSITION VARCHAR(100),EMAIL_ADDR VARCHAR(100))
CREATE MEMORY TABLE I18N(MESSAGE_CODE varchar(30), CHINESE varchar(100), KOREAN varchar(100))
CREATE MEMORY TABLE UIP_EMPLOYEE(NUM VARCHAR(10),NAME VARCHAR(50),BIRTHDATE VARCHAR(20),SEX CHAR(1),TELEPHONE VARCHAR(10),ADDRESS VARCHAR(100),POSTAL VARCHAR(10))
SET SCHEMA PUBLIC
...
INSERT INTO UIP_EMPLOYEE VALUES('4000001','name01','19701201', 'F','263000001','KSCC A', '140201')
INSERT INTO UIP_EMPLOYEE VALUES('4000002','name02','19701201', 'M','263000001','KSCC B', '140201')
INSERT INTO UIP_EMPLOYEE VALUES('4000003','name03','19701201', 'F','263000001','KSCC C', '140201')
